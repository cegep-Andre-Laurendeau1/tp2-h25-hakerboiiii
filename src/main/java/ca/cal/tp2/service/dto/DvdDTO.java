...
public class DvdDTO extends DocumentDTO  {
    ...
    public DvdDTO(Long id, String titre, int nbExemplaires, LocalDate annee, String director, int duration, String rating) {
    ...
    public static DvdDTO toDTO(Dvd dvd) {
        return new DvdDTO(dvd.getId_document(), dvd.getTitre(), dvd.getNbExemplaires(),
